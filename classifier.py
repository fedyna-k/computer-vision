...
class ImageClassifier:
  ...
  def __init__(self, path):
    ...
    train, test, label_train, label_test, self.__LABELS = scrapper.get_all_pictures(path)
    ...
    print("Creating histograms for features...")
    ...
    print(f"KNN score after training: {self.__KNN.score(features_test, label_test)}")
    ...
    print(f"SVC score after training: {self.__SVC.score(features_test, label_test)}")
